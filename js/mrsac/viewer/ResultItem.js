define(["dojo/_base/declare", "viewer/_MapGraphicsMaintainer", "viewer/widgets/locatebylat", "dijit/_WidgetBase", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", "dijit/_Container", "dojo/text!./templates/ResultItem.html", "dojo/dom-attr", "dojo/dom", "dojo/on", "dojo/dom-style", "dojo/sniff", "dojo/dom-class", "dojo/query", "dojo/_base/lang", "dojo/_base/event", "dojo/topic", "esri/geometry/Point", "esri/SpatialReference", "dojo/_base/connect", "viewer/MapManager", "dojo/NodeList-traverse"], function(declare, _MapGraphicsMaintainer, locatebylat, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, _Container, template, domAttr, dom, on, domStyle, has, domClass, query, lang, event, topic, Point, SpatialReference, connect, MapManager) {
	...
	return declare("mrsac.viewer.ResultItem", [_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, _Container, mrsac.viewer._MapGraphicsMaintainer, mrsac.viewer.MapManager], {
		...
		clearResult : function(evt) {
			...
			var newItem = document.getElementsByClassName("resultsMsg")[0].innerHTML
			var domResult = newItem.lastIndexOf("location");
			var domResult1 = newItem.substring(0, domResult)

			var val1 = parseInt(domResult1) - 1
			var domResult2 = newItem.substring(domResult)
			newItem = val1 + "&nbsp;" + domResult2;

			document.getElementsByClassName("resultsMsg")[0].innerHTML = newItem
