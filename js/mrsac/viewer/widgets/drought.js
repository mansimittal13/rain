	...
	return declare ("mrsac.viewer.widgets.drought", [mrsac.viewer._ThemeWidget, mrsac.viewer.domain], {
		...
		startup : function () {
			...
			try {
				...
				this.loadinggp = dom.byId ("divLoadingIndicatornew");
		...
		getAssets1 : function (evt) {
			...
			//	alert("Download CSV");
			//this.loadmrsac ();
			var drydaydate = document.getElementById ('drydaydate1').value;

			drydayeval = this.covertdatecombine (drydaydate);
			var drydayurl = document.getElementById ('drydaydate2').value;
			console.log (drydayeval);
			console.log (drydayurl);
			var paramsGeo3 = {
				"Zvalue" : drydayeval,
				"urlpath" : drydayurl
			};
			...
			//---------------------
			var gpPrint3 = new Geoprocessor ("http://117.240.213.119/gp/rest/services/drought/drydayscript/GPServer/drydayscript");
		...
		getAssets2 : function (evt) {
			...
			var month_yearval = document.getElementById ('rd_dev1').value;
			var rd_url = document.getElementById ('rd_dev2').value;
			console.log (month_yearval);
			console.log (rd_url);
			var paramsGeo2 = {
				"Zvalue" : month_yearval,
				"urlpath" : rd_url
			};

			//---------------------
			var gpPrint2 = new Geoprocessor ("http://117.240.213.119/gp/rest/services/drought/rainfallDeviationScript/GPServer/rainfallDeviationScript");
			gpPrint2.execute (paramsGeo2, lang.hitch (this, this.savegpComplete), lang.hitch (this, this.gpJobFailed));
		},
		/**************** Daily Analysis
		 * *************************************************************************/
		...
		rdinfo : function () {
			swal ("For Input Month and Year Value." + "\n" + "Ex- JUN2018" + "\n" + "\n" + "For Input URL." + "\n" + "Ex- http://117.240.213.118:6080/droughtServiceMaharain/Resource/GetRainfallDeviation/ ")
		},
		drydayinfo : function () {
			swal ("For Input Month and Year Value." + "\n" + "Ex- JUN2018" + "\n" + "\n" + "For Input URL." + "\n" + "Ex- http://117.240.213.118:6080/droughtService/Resource/GetDryDaysOnset/")
		},
		percentnrinfo : function () {
			swal ("For Input Month and Year Value." + "\n" + "Ex- JUN2018" + "\n" + "\n" + "For Input URL." + "\n" + "Ex- http://117.240.213.118:6080/droughtService/Resource/GetDryDaysOnset/")
		},
		totalraininfo : function () {
		},
	});
});
