	...
	return declare("mrsac.viewer.widgets.locatebylat", [mrsac.viewer._BaseWidget, mrsac.viewer._MapGraphicsMaintainer], {
		...
		startup : function() {
			...
			try {
				...
				this.connects.push(connect.connect(this.widgets.btnLocateCoords, "onClick", this, "onCoordLocate"));
				this.connects.push(connect.connect(this.widgets.btnClearCoords, "onClick", this, "onCoordClear"));
		...
		onCoordLocate : function(evt) {
			...
			try {
				...
				var y = this.widgets.longitude.getValue();
				var x = this.widgets.latitude.getValue();

				var pt = new Point(y, x, new SpatialReference({
					wkid : 4326
				}));
				var geom1 = webMercatorUtils.geographicToWebMercator(pt);
				...
				var g = new Graphic(geom1, this.symbol, attrs);
