define(["viewer/ResultItem2", "dojo/_base/declare", "dijit/_WidgetBase", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", "dijit/_Container", "dojo/on", "dojo/_base/array", "dojo/_base/connect"], function(ResultItem2, declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, _Container, on, array, connect) {

	return declare("mrsac.viewer.ResultList2", [_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, _Container], {
		...
		add : function(/*Object|ResultItem*/obj) {
			try {
				if (obj) {
					...
					var item = null;
					if (obj.declaredClass === "mrsac.viewer.ResultItem2") {
						...
						item = new mrsac.viewer.ResultItem2(obj);
